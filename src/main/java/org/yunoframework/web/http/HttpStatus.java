...
public enum HttpStatus {
	...
	/**
	 * Returns HttpStatus by it's status code's number
	 * @param statusCode number of status code
	 * @return HttpStatus with given status code, null if not found
	 */
	public static HttpStatus byCode(int statusCode) {
	...
	/**
	 * Returns type of HttpStatus
	 * @return type of HttpStatus {@see HttpStatus.Type}
	 */
